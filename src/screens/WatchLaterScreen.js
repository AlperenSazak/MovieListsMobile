...
export default function WatchLaterScreen({ navigation }) {
    ...
    const renderMovie = ({ item }) => (
        ...
        >
            ...
            <View style={styles.movieInfo}>
                ...
                {item.overview ? <Text style={styles.movieOverview} numberOfLines={2}>{item.overview}</Text> : null}
        ...
        <View style={styles.container}>
            ...
            {loading ? (
                ...
                <View style={styles.emptyState}>
                    ...
                    <Text style={styles.emptyStateSubText}>Ara sekmesinden filmleri daha sonra izlemek için ekleyebilirsin.</Text>
                </View>
            ) : (
                <FlatList
                    data={movies}
...
const styles = StyleSheet.create({
    ...
    moviePoster: { width: 100, height: 150, position: 'absolute' },
    noPoster: { fontSize: 40 },
    ...
    buttonRow: { flexDirection: 'row', gap: 8, marginTop: 'auto' },
    ...
    addButtonText: { color: '#667eea', fontSize: 12, fontWeight: '600' },
    deleteButton: { backgroundColor: 'rgba(220, 53, 69, 0.3)', borderWidth: 1, borderColor: 'rgba(220, 53, 69, 0.5)', borderRadius: 8, padding: 8, alignItems: 'center', width: 40 },
